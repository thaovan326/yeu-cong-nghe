...
(function (h) {
    ...
    function ka(a) {
        ...
        if (a.scrollBarVis !== K && a.scrollBarVis !== k) (a.scrollBarVis = K), Y(a);
            ...
            if ('' === c) {
                ...
                if (
                    T &&
                    (p.find('tbody').height() > j.offsetHeight || 'scroll' == l.css('overflow-y'))
                )
    ...
    function Hb(a) {
        for (
            var b, c, d = a.aoColumns, e = V(a), a = a.oLanguage.oAria, f = 0, g = d.length;
            f < g;
            f++
        ) {
            c = d[f];
    ...
    o('draw()', function (a) {
        return this.iterator('table', function (b) {
            'page' === a
                ? N(b)
                : ('string' === typeof a && (a = 'full-hold' === a ? !1 : !0), S(b, !1 === a));
        });
    });
    o('page()', function (a) {
        return a === k
